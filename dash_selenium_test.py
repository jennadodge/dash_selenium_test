...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([
            dcc.Markdown(id='zip_confirmation',children='')], width=12)
    ], justify='center'),

    dbc.Row([
        dbc.Col([
            dcc.Markdown(id='main_utility',children='')], width=12)
    ], justify='center'),

    dbc.Row([
        dbc.Col([
            dcc.Markdown(id='scraping_confirmation',children='')], width=12)
    ], justify='center'),
...
@app.callback(
    Output("zip_confirmation",'children'),
